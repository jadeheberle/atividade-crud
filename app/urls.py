...
from .views import FuncionarioCreateView, FuncionarioListView, FuncionarioUpdateView, FuncionarioDetailView, FuncionarioDeleteView, toggle_ativo_funcionario
...
urlpatterns = [
        ...
        path("toggle_ativo_funcionario/<int:pk>/", toggle_ativo_funcionario,name="toggle_ativo_funcionario"),
